...
az appservice plan create -n $appname -g $resourcegroup --is-linux -l "South Central US" --sku P1V2 --number-of-workers 3
...
az webapp deployment slot swap --name $appname --resource-group $resourcegroup \
--slot staging
